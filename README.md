...
-株式会社HRクラウドにて、採用管理システム「かんりくん」の開発を担当しています。  
-フロントエンドからバックエンド、インフラ運用まで幅広く関わる **Webアプリケーション領域のフルスタックエンジニア** として、  
-新機能開発・既存機能改善・パフォーマンス最適化・UI/UX改善などを行っています。

- 使用技術：PHP (FuelPHP) / JavaScript / MySQL / Docker / Nginx / GitHub  
- 開発体制：GitHub PR ベース / Slack でのコミュニケーション / CI を用いた開発プロセス  
- 担当領域：設計 / 実装 / コードレビュー / 仕様整理 / 運用・保守
